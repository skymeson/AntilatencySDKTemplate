...
public interface IAndroidJni : AntilatencyInterfaceContract.IInterface {
	void initJni(System.IntPtr vm, System.IntPtr context);
}
namespace Details {
	public class IAndroidJniWrapper : AntilatencyInterfaceContract.Details.IInterfaceWrapper, IAndroidJni {
	...
	public class IAndroidJniRemap : AntilatencyInterfaceContract.Details.IInterfaceRemap {
		public new struct VMT {
			public delegate AntilatencyInterfaceContract.ExceptionCode initJniDelegate(System.IntPtr _this, System.IntPtr vm, System.IntPtr context);
